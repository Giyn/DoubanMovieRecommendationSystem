    ...
    def __init__(self, name):
        ...
        try:
            ...
            if pd.isna(list(self.movies_detailed[self.movies_detailed.name == "{}".format(self.name)].style2)[0]) and pd.isna(list(self.movies_detailed[self.movies_detailed.name == "{}".format(self.name)].style3)[0]):
                ...
                self.style = list(self.movies_detailed[self.movies_detailed.name == "{}".format(self.name)].style1)[0] + ' ' + list(self.movies_detailed[self.movies_detailed.name == "{}".format(self.name)].style2)[0]
            else:
                self.style = list(self.movies_detailed[self.movies_detailed.name == "{}".format(self.name)].style1)[0] + ' ' + list(self.movies_detailed[self.movies_detailed.name == "{}".format(self.name)].style2)[0] + ' ' + list(self.movies_detailed[self.movies_detailed.name == "{}".format(self.name)].style3)[0]
